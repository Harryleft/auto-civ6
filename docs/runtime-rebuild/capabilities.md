...
- `get_runtime_context` 未包含的细粒度读取，例如地图/视野、战斗或路径估算、奇观格点候选、
  外交交易选项、单位/间谍/宗教详情。
- 尚未暴露的写操作：建设者的修复、清除和筑路，非唯一/条款不完整交易的接受或拒绝、宗教（万神殿除外）、间谍、世界议会投票、奇观及
  任何未列在上表的 mutation。
